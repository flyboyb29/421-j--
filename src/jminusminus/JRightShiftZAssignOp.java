...
public class JRightShiftZAssignOp extends JAssignment {
 
	public JRightShiftZAssignOp(int line, JExpression lhs, JExpression rhs) {
		super(line, ">>>=", lhs, rhs);
	}
	...
	public JExpression analyze(Context context) {
		...
		if (this.lhs.type().equals(Type.INT)) {
			...
			JAST.compilationUnit.reportSemanticError(line(), "Invalid lhs type for >>>=: " + this.lhs.type(), new Object[0]);
		}
		return this;
	}
